...
# Dato devuelto: Valor lógico indicando si es bisiesto (Verdadero)
#o no (Falso)

def EsBisiesto(year):
	return (year % 4 == 0 and not (year % 100 == 0)) or year % 400 == 0

# Función DiasDelMes: Recibe un mes y un año y devuelve el número de días
#que tiene ese mes en ese año. Necesita la función EsBisiesto
...
# Función Calcular_Dia_Juliano: Recibe un día, mes y año y devuelve el día
#juliano correspondiente a esa fecha. El día juliano correspondiente a una
#fecha es un número entero que indica los días que han transcurrido desde el
#1 de enero del año indicado. Depende de la función DiasDelMes
...
#el día juliano que corresponde.
